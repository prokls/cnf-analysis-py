...
"""
    cnf-analysis-dirinfo
    ====================

    Given me a directory, I will tell you whether all .stats files exist
...
def is_file_to_ignore(filepath: str) -> bool:
    ...
    if os.path.basename(filepath).startswith('README'):
        return True
    if os.path.splitext(filepath)[1] == '.pdf' or os.path.splitext(filepath)[1] == '.stats':
        return True
    return False
